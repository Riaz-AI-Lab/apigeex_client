...
def _get_kwargs(
    *,
    ...
    content_mode: Union[Unset, str] = UNSET,
    identifier: Union[Unset, str] = UNSET,
    language: Union[Unset, str] = UNSET,
    supplements: Union[Unset, str] = UNSET,
    ...
    params["content-mode"] = content_mode
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        content_mode (Union[Unset, str]):
        identifier (Union[Unset, str]):
        language (Union[Unset, str]):
        supplements (Union[Unset, str]):
